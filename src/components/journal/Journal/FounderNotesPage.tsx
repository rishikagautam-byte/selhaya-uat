...
export default function FounderNotesPage() {
    const { articles, loading } = useJournalArticles("founder-notes");
    ...
    return (
        <>
            <SEO
                title={SEO_CONFIG.founderNotes.title}
                description={SEO_CONFIG.founderNotes.description}
                canonical={SEO_CONFIG.founderNotes.canonical}
                type="article"
            />
            <HeroSection
            ...
            <section className="bg-primary-light py-10 px-6 md:px-12 lg:px-20">
                {loading ? (
                    ...
                    >
                        <p className="text-[14px] uppercase tracking-widest text-text/50 mb-4">Founder Notes</p>
