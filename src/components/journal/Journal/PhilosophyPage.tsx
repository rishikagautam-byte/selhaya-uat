...
export default function PhilosophyPage() {
    const { articles, loading } = useJournalArticles("maison-milestones");
    ...
    return (
        <>
            <SEO
                title={SEO_CONFIG.journalPhilosophy.title}
                description={SEO_CONFIG.journalPhilosophy.description}
                canonical={SEO_CONFIG.journalPhilosophy.canonical}
                type="article"
            />
            <HeroSection
                image="/images/journal/hero.png"
                title="Thoughts Carried Through Heritage"
                desktopText={<>Reflections that weave past and present into <br /> timeless conversation.</>}
            ...
            <section className="bg-primary-light py-10 px-6 md:px-12 lg:px-20">
                {loading ? (
                    ...
                    >
                        <p className="text-[14px] uppercase tracking-widest text-text/50 mb-4">Maison milestones</p>
