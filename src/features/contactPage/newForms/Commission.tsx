...
import commissionImg from "../../../assets/forms/commission.png";
...
const INTEREST_OPTIONS = ["Silk Garment", "Silk Art", "Other"];
...
const Commission = () => {
    ...
    const validateForm = () => {
        ...
        if (selectedInterests.length === 0) {
            toast.error("Please select at least one interest type");
            return false;
        }
    ...
    const submitEnquiry = async (token: string) => {
        ...
        try {
            ...
            formData.append("action", "Commission");
            formData.append("fullName", form.fullName.trim());
            formData.append("email", form.email.trim());
            formData.append("location", selectedLocation?.name || "");
            formData.append("interestType", selectedInterests.join(", "));
    ...
    return (
        <>
            <SEO
                title="Begin a Private Consultation | SELHAYA®"
                description="The House accepts a limited number of Bespoke commissions annually. Private consultations are arranged directly through the Maison following submission and review."
            ...
            <section className="min-h-screen grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] bg-primary-light text-text">
                ...
                <div className="w-full flex flex-col justify-center px-6 xl:px-16 py-12 md:py-6 mt-20 overflow-y-auto">
                    <div className="lg:pr-20">
                        ...
                        {/* Subtext */}
                        <p className="text-[16px] text-text/90 mb-8 max-w-[580px]">
                            The House accepts a limited number of Bespoke commissions annually. Private consultations are arranged directly through the Maison following submission and review.
                        </p>
                        ...
                        <div className="w-full flex flex-col">
                            ...
                            {/* Row 3: Interest Type Field Group */}
                            <div className="mt-6">
                                    ...
                                    {INTEREST_OPTIONS.map((option) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <span className="text-[13px] sm:text-[14px] text-[#281B1380] group-hover:text-text transition-colors font-light">
                                                    {option}
                                                </span>
                                            </label>
                                        );
