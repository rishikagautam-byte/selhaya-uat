...
const pages = Array.from({ length: 32 }, (_, i) => ({
  src: `/images/haya/Haya Edition (digital) (1)_page-${String(i + 1).padStart(4, "0")}.jpg`,
  alt: "Haya Long book",
  num: i === 0 ? 0 : i + 1,
}));
...
function Book() {
  ...
  const handleDownload = () => {
    ...
    link.href = "/pdfs/Haya-Edition.pdf"; // TODO: Add your Haya PDF here
    link.download = "Selhaya-Haya-Edition.pdf";
