...
/* ─── Spread pages data ─── */
const pages = [
  { src: "/images/hayaPDF/1.png", alt: "Heritage book", num: 0 },
  { src: "/images/hayaPDF/2.png", alt: "Heritage book", num: 2 },
  { src: "/images/hayaPDF/3.png", alt: "Heritage book", num: 3 },
  { src: "/images/hayaPDF/4.png", alt: "Heritage book", num: 4 },
  { src: "/images/hayaPDF/5.png", alt: "Heritage book", num: 5 },
  { src: "/images/hayaPDF/6.png", alt: "Heritage book", num: 6 },
  { src: "/images/hayaPDF/7.png", alt: "Heritage book", num: 7 },
  { src: "/images/hayaPDF/8.png", alt: "Heritage book", num: 8 },
  { src: "/images/hayaPDF/9.png", alt: "Heritage book", num: 9 },
  { src: "/images/hayaPDF/10.png", alt: "Heritage book", num: 10 },
  { src: "/images/hayaPDF/11.png", alt: "Heritage book", num: 11 },
  { src: "/images/hayaPDF/12.png", alt: "Heritage book", num: 12 },
  { src: "/images/hayaPDF/13.png", alt: "Heritage book", num: 13 },
  { src: "/images/hayaPDF/14.png", alt: "Heritage book", num: 14 },
];
...
function HeritageBook() {
  ...
  const handleDownload = () => {
    ...
    // Purana original PDF yahan hai:
    link.href = "/src/assets/YAQEENSelhayaLookbook.pdf";
    link.download = "Selhaya-Heritage-Lookbook.pdf";
    ...
    <section className="bg-section-bg py-20">
      <div className="flex flex-col items-center justify-center w-full">
        <h2 className="text-[32px] text-center">
          A Visual Chronicle of Heritage in Pure Silk
        </h2>

        <p className="text-[14px] text-center mt-1">
          The Heritage collection embodies Selhaya's signature dialogue
          <br />
